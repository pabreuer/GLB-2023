...
*** Date: 07/25/2023														****
*** Author: P. Breuer														****
*** Project: U.S. Sample - Firm Level Analyses								****
********************************************************************************
...
* Table S4 Panel A: Descriptive Statistics for Corporate Carbon Damages	
bysort price_label: tabstat damage, stat("count mean sd p10 p25 p50 p75 p90") 

* Figure 1 Panel B: Corporate Carbon Damages relative to Operating Income
	...
	* Plot Graph
	...
	graph export fig1b_inc.emf, replace 
...
* Export graph data
	...
	* Export to excel
	export excel using Appendix.xlsx, sheet("Fig1B_Inc", replace) firstrow(var) 
...
* Table S4 Panel B: Descriptive Statistics for Corporate Carbon Damages
bysort price_label: tabstat damage, stat("count mean sd p10 p25 p50 p75 p90") 

* Figure 1 Panel B: Corporate Carbon Damages relative to Revenue
	...
	* Plot Graph
	...
	graph twoway rbar udc ldc price, fcolor(gs10) lcolor(none) barw(.15) horizontal || ///
		...
		xscale(titlegap(3.5)) ylabel(3 "SCC = $51" 2 "SCC = $190" 1 "SCC = $250", labsize(medsmall) angle(0)) ///
		graphregion(color(white) margin(vlarge)) plotregion(fcolor(white)) 
	graph export fig1b_rev.emf, replace 
...
* Export graph data
	...
	* Export to excel
	export excel using Appendix.xlsx, sheet("Fig1B_Rev", replace) firstrow(var) 	
